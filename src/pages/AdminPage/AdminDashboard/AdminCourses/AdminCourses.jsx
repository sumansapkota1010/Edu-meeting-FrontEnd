...
const AdminCourses = () => {
    ...
    const fetchCourses = async () => {
        try {
            const response = await axios.get('https://edu-meeting-backend.onrender.com/api/courses/');
    ...
    const handleDelete = async (courseId) => {
        ...
        try {
            await axios.delete(`https://edu-meeting-backend.onrender.com/api/courses/${courseId}`, {
