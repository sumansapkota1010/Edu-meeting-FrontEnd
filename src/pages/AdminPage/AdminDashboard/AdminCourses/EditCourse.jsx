...
const Editcourse = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.patch(`https://edu-meeting-backend.onrender.com/api/courses/${id}`, form, {
                headers: {
    ...
    const fetchSingleData = async () => {
        try {
            const response = await axios.get(`https://edu-meeting-backend.onrender.com/api/courses/${id}`);
