...
const AdminUser = () => {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                const response = await axios.get('https://edu-meeting-backend.onrender.com/api/admin/user', {
    ...
    const handleDelete = async (userId) => {
        ...
        try {
            await axios.delete(`https://edu-meeting-backend.onrender.com/api/admin/user/${userId}`,
                {
                    headers: {
