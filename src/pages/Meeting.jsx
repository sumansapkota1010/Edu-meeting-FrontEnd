...
const Meeting = () => {
    ...
    const fetchApi = async () => {
        ...
        setError(null);
        try {
            const response = await axios.get(`https://edu-meeting-backend.onrender.com/api/meetings/category/${category}`, {
                headers: {
                            ...
                            return (
                                <div key={meeting._id} className='flex flex-col items-center mb-[30px] xl:h-[367px] xl:w-[353px] 2xl:h-[400px] 2xl:w-[409px]   '>
                                    <img
                                        ...
                                        alt={meeting.title}
                                    />
                                    <div className='flex flex-col bg-white  p-4 rounded-br-[20px] rounded-bl-[20px] sm:h-[146px] sm:w-[519px] md:h-[220px] md:w-[300px] md:p-[30px] lg:h-[146px] lg:w-[408px] xl:h-[156px] xl:w-[329px] 2xl:h-[156px] 2xl:w-[385px]   shadow-md'>
