        ...
        <div className="bg-white/20">
            <div className='container py-8 flex flex-col xl:flex-row justify-between px-4 xl:px-0'>
                ...
                <div className="hidden justify-between md:flex gap-x-4 items-center whitespace-nowrap">
                    ...
                    <NavigationLink to="apply" onClick={handleApplyNowClick} smooth={true} duration={500}>
                        APPLY NOW
                    </NavigationLink>
                ...
                {isOpen && (
                    <div className="mobile-nav">
                        ...
                        <MobileNavigationLink to="apply" onClick={handleApplyNowClick} smooth={true} duration={500}>
                            APPLY NOW
                        ...
                        {!localStorage.getItem('token') ? (
                            ...
                            <MobileNavigationLink onClick={handleLogout}>Logout</MobileNavigationLink>
                        )}
                    </div>
                )}
            </div>
