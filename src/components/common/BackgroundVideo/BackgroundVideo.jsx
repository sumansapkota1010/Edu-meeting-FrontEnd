        ...
        <div className="relative overflow-hidden w-full h-screen">
            ...
            <div className="relative z-10 w-full h-full bg-black bg-opacity-70">
                ...
                <div className='container px-4 xl:px-0'>
                    <h6 className='text-[#ffffff] font-poppins font-bold text-[15px] mt-[240px] mb-[15px] '>HELLO STUDENTS</h6>
                    <h2 className='text-[#ffffff] font-poppins text-[36px] font-extrabold '>WELCOME TO EDUCATION</h2>
                    <p className='text-[#ffffff]  text-[14px] tracking-normal text-start font-poppins font-normal mt-[20px]  leading-6 mb-4 '>
                        ...
                        This <br /> is a Bootstrap v5.1.3 layout. The video background is taken from Pexels website,
                        a <br /> group of young people by{' '}
                        <a
                    ...
                    <div className='py-4'>
                        <a href="#contactus" className='bg-[#a12c2f] text-white text-[13px]  font-poppins font-medium py-[12px] px-[30px] rounded-[22px]'>
                            JOIN US NOW! </a>
